...
from segnext.FreqFusion import FreqFusion
from typing import Optional, Union, List
from segmentation_models_pytorch.base.modules import Activation
from .Sugarcane_CA import Sugarcane_CA
"""
...
class SegNeXt(nn.Module):
    ...
    def __init__(
        ...
        output_dir = "/root/autodl-tmp/Project/rs-segment-pytorch-main/BuChongShiYan/1_SugarPriorAM/5_GuoChengWenJian"

        self.Attention = Sugarcane_CA(output_dir=output_dir, channel=3).cuda()
    ...
    def forward(self, inputs, filenames, ei=None):
        inputs_Att = self.Attention(inputs, filenames, ei)

        out = self.backbone(inputs_Att)
